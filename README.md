# Nokta'nın Filmleri · Nokta's Films
...
- `index.html`: the whole page, a single file with no build step. To add a film, add one entry to the `FILMS` list in the script.
- `videos/`: 720p copies of each film (16:9, Turkish captions burned in).
